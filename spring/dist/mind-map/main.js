...
var RestService = /** @class */ (function () {
    ...
    RestService.prototype.download = function (fileName, lid, mapid) {
        ...
        var url = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/download';
    ...
    RestService.prototype.download1 = function (fileName, lid, mapid) {
        var _this = this;
        console.log('restservice export start');
        var url = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/download1';
        var body = { 'filename': fileName,
            'lid': lid,
            'mapid': mapid };
        this.downloadService.requestBlob(url, body).subscribe(function (result) {
    ...
    RestService.prototype.show = function () {
        var url = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/showfile/1';
        // 得到文件名称数组
        return this.downloadService.showfile(url);
    };
    RestService.prototype.showLink = function (lid, node_id, mapid) {
        var url = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/get_link';
        var body = {
            'lid': lid,
            'node_id': node_id,
            'mapid': mapid,
    ...
    RestService.prototype.uploadLink = function (linkname, linkcontent, lid, node_id, mapid) {
        var url = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/upload_link';
        var body = {
            'linkname': linkname,
    ...
    RestService.prototype.uploadFileDescription = function (filename, fd, lid, node_id, mapid) {
        ...
        upFile.mapid = mapid;
        console.log(upFile);
        var url = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/upload_fd';
    ...
    RestService.prototype.uploadFileDescription1 = function (filename, fd, lid, node_id, mapid) {
        ...
        upFile.mapid = mapid;
        console.log(upFile);
        var url = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/upload_fd1';
        return this.http.post(url, upFile);
    };
...
var ScoursewareComponent = /** @class */ (function () {
    function ScoursewareComponent(router, route, restService, userService) {
        ...
        this.url = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/upload/';
    }
...
var TresourceComponent = /** @class */ (function () {
    function TresourceComponent(router, route, restService, userService, elementRef) {
        ...
        this.show_hide_val1 = false;
        this.upfiles = new _upfiles__WEBPACK_IMPORTED_MODULE_3__["UpFiles"]();
        this.url = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/upload/1';
        this.uploader = new ng2_file_upload__WEBPACK_IMPORTED_MODULE_1__["FileUploader"]({ url: this.url });
        this.filedescription = new ngx_bootstrap__WEBPACK_IMPORTED_MODULE_6__["LinkedList"]();
    }
...
var UserService = /** @class */ (function () {
    function UserService(http) {
        this.http = http;
        this.registerUrl = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/register';
        this.loginUrl = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/login';
        this.lessonUrl = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/teacher_lessons/';
        this.addUrl = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/teacher_add_lessons/';
        this.add2Url = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/student_add_lessons/';
        this.courseUrl = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/student_lessons/';
        this.addAllUrl = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/addAll';
        this.saveMindMapUrl = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/saveMindMap';
        this.getMindMapUrl = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/getMindMap';
        this.saveNumUrl = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/saveNum';
        this.getNumUrl = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/getNum';
        this.addQ0Url = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/addQ0';
        this.getQ0Url = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/getQ0';
        this.addQ1Url = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/addQ1';
        this.getQ1Url = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/getQ1';
        this.removeQ0Url = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/removeQ0';
        this.removeQ1Url = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/removeQ1';
        this.submitUrl = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/submit';
    }
    ...
    UserService.prototype.changePass = function (password) {
        var examineloginUrl = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/changePass';
        return this.http.post(examineloginUrl, password);
    };
    UserService.prototype.examineLogin = function (username) {
        var examineloginUrl = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/examinelogin/' + username;
        return this.http.post(examineloginUrl, []);
    };
    UserService.prototype.exitLogin = function (username) {
        var examineloginUrl = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/exitlogin/' + username;
        return this.http.post(examineloginUrl, []);
    };
    ...
    UserService.prototype.showWare = function (mpnode) {
        var url = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/showWare';
        return this.http.post(url, mpnode);
    };
    UserService.prototype.showResource = function (mpnode) {
        var url = 'http://13.67.110.158:8004/pj-0.0.1-SNAPSHOT/showResource';
        return this.http.post(url, mpnode);
    };

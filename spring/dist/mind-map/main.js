...
var RestService = /** @class */ (function () {
    ...
    RestService.prototype.download1 = function (fileName, lid, mapid) {
        var _this = this;
        console.log('restservice export start');
        var url = 'http://localhost:8080/download1';
        var body = { 'filename': fileName,
            'lid': lid,
            'mapid': mapid };
        this.downloadService.requestBlob(url, body).subscribe(function (result) {
    ...
    RestService.prototype.uploadLink = function (linkname, linkcontent, lid, node_id, mapid) {
        var url = 'http://localhost:8080/upload_link';
        var body = {
            'linkname': linkname,
    ...
    RestService.prototype.uploadFileDescription = function (filename, fd, lid, node_id, mapid) {
        ...
        upFile.mapid = mapid;
        console.log(upFile);
        var url = 'http://localhost:8080/upload_fd';
    ...
    RestService.prototype.uploadFileDescription1 = function (filename, fd, lid, node_id, mapid) {
        ...
        upFile.mapid = mapid;
        console.log(upFile);
        var url = 'http://localhost:8080/upload_fd1';
        return this.http.post(url, upFile);
    };
...
var TresourceComponent = /** @class */ (function () {
    function TresourceComponent(router, route, restService, userService, elementRef) {
        ...
        this.show_hide_val1 = false;
        this.upfiles = new _upfiles__WEBPACK_IMPORTED_MODULE_3__["UpFiles"]();
        this.url = 'http://localhost:8080/upload/1';
        this.uploader = new ng2_file_upload__WEBPACK_IMPORTED_MODULE_1__["FileUploader"]({ url: this.url });
        this.filedescription = new ngx_bootstrap__WEBPACK_IMPORTED_MODULE_6__["LinkedList"]();
    }
...
var UserService = /** @class */ (function () {
    function UserService(http) {
        ...
        this.lessonUrl = 'http://localhost:8080/teacher_lessons/';
        this.addUrl = 'http://localhost:8080/teacher_add_lessons/';
        this.add2Url = 'http://localhost:8080/student_add_lessons/';
        this.courseUrl = 'http://localhost:8080/student_lessons/';
        this.addAllUrl = 'http://localhost:8080/addAll';
        this.saveMindMapUrl = 'http://localhost:8080/saveMindMap';
        this.getMindMapUrl = 'http://localhost:8080/getMindMap';
        this.saveNumUrl = 'http://localhost:8080/saveNum';
        this.getNumUrl = 'http://localhost:8080/getNum';
        this.addQ0Url = 'http://localhost:8080/addQ0';
        this.getQ0Url = 'http://localhost:8080/getQ0';
        this.addQ1Url = 'http://localhost:8080/addQ1';
        this.getQ1Url = 'http://localhost:8080/getQ1';
        this.removeQ0Url = 'http://localhost:8080/removeQ0';
        this.removeQ1Url = 'http://localhost:8080/removeQ1';
        this.submitUrl = 'http://localhost:8080/submit';
    }

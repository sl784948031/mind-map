...
var RestService = /** @class */ (function () {
    ...
    RestService.prototype.download = function (fileName, lid, mapid) {
        ...
        var url = 'http://13.67.110.158:8004/download';
    ...
    RestService.prototype.download1 = function (fileName, lid, mapid) {
        var _this = this;
        console.log('restservice export start');
        var url = 'http://13.67.110.158:8004/download1';
        var body = { 'filename': fileName,
            'lid': lid,
            'mapid': mapid };
        this.downloadService.requestBlob(url, body).subscribe(function (result) {
    ...
    RestService.prototype.uploadLink = function (linkname, linkcontent, lid, node_id, mapid) {
        var url = 'http://13.67.110.158:8004/upload_link';
        var body = {
            'linkname': linkname,
    ...
    RestService.prototype.uploadFileDescription = function (filename, fd, lid, node_id, mapid) {
        ...
        upFile.mapid = mapid;
        console.log(upFile);
        var url = 'http://13.67.110.158:8004/upload_fd';
    ...
    RestService.prototype.uploadFileDescription1 = function (filename, fd, lid, node_id, mapid) {
        ...
        upFile.mapid = mapid;
        console.log(upFile);
        var url = 'http://13.67.110.158:8004/upload_fd1';
        return this.http.post(url, upFile);
    };
...
var ScoursewareComponent = /** @class */ (function () {
    function ScoursewareComponent(router, route, restService, userService) {
        ...
        this.url = 'http://13.67.110.158:8004/upload/';
    }
...
var TcoursewareComponent = /** @class */ (function () {
    ...
    TcoursewareComponent.prototype.getID1 = function () {
        ...
        var node_id = this.route.snapshot.paramMap.get('node_id');
        this.node_id = node_id;
        this.url = 'http://13.67.110.158:8004/upload_ware/' + this.lid + "/" + this.node_id + "/" + this.mapid;
        console.log(this.url);
        this.uploader = new ng2_file_upload__WEBPACK_IMPORTED_MODULE_1__["FileUploader"]({ url: this.url });
        var username = this.route.snapshot.paramMap.get('username');
        this.username = username;
...
var TresourceComponent = /** @class */ (function () {
    function TresourceComponent(router, route, restService, userService, elementRef) {
        ...
        this.show_hide_val1 = false;
        this.upfiles = new _upfiles__WEBPACK_IMPORTED_MODULE_3__["UpFiles"]();
        this.url = 'http://13.67.110.158:8004/upload/1';
        this.uploader = new ng2_file_upload__WEBPACK_IMPORTED_MODULE_1__["FileUploader"]({ url: this.url });
        this.filedescription = new ngx_bootstrap__WEBPACK_IMPORTED_MODULE_6__["LinkedList"]();
    }
...
var UserService = /** @class */ (function () {
    function UserService(http) {
        this.http = http;
        this.registerUrl = 'http://13.67.110.158:8004/register';
        this.loginUrl = 'http://13.67.110.158:8004/login';
        this.lessonUrl = 'http://13.67.110.158:8004/teacher_lessons/';
        this.addUrl = 'http://13.67.110.158:8004/teacher_add_lessons/';
        this.add2Url = 'http://13.67.110.158:8004/student_add_lessons/';
        this.courseUrl = 'http://13.67.110.158:8004/student_lessons/';
        this.addAllUrl = 'http://13.67.110.158:8004/addAll';
        this.saveMindMapUrl = 'http://13.67.110.158:8004/saveMindMap';
        this.getMindMapUrl = 'http://13.67.110.158:8004/getMindMap';
        this.saveNumUrl = 'http://13.67.110.158:8004/saveNum';
        this.getNumUrl = 'http://13.67.110.158:8004/getNum';
        this.addQ0Url = 'http://13.67.110.158:8004/addQ0';
        this.getQ0Url = 'http://13.67.110.158:8004/getQ0';
        this.addQ1Url = 'http://13.67.110.158:8004/addQ1';
        this.getQ1Url = 'http://13.67.110.158:8004/getQ1';
        this.removeQ0Url = 'http://13.67.110.158:8004/removeQ0';
        this.removeQ1Url = 'http://13.67.110.158:8004/removeQ1';
        this.submitUrl = 'http://13.67.110.158:8004/submit';
    }
    ...
    UserService.prototype.showWare = function (mpnode) {
        var url = 'http://13.67.110.158:8004/showWare';
        return this.http.post(url, mpnode);
    };
    UserService.prototype.showResource = function (mpnode) {
        var url = 'http://13.67.110.158:8004/showResource';
        return this.http.post(url, mpnode);
    };
